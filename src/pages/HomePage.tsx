  ...
  return (
    <>
      ...
      <section class="bg-white px-4 pb-4 pt-8 text-black md:px-8">
        ...
        {/* Gold Sponsors */}
        <div class="animate-on-scroll-in-view animation-delay-100 text-center lg:py-4">
        ...
        {/* Silver Sponsors */}
        <div class="animate-on-scroll-in-view animation-delay-200 text-center lg:py-4">
        ...
        {/* Bronze Sponsors */}
        <div class="animate-on-scroll-in-view animation-delay-300 text-center lg:py-4">
        ...
        {/* Special Sponsors */}
        <div class="animate-on-scroll-in-view animation-delay-400 text-center lg:py-4">
      ...
      <section class="bg-white px-4 pb-8 pt-4 text-black md:px-8">
        <div class="animate-on-scroll-in-view animation-delay-500 flex py-8 text-center">
          <h2 class="mx-auto text-center text-3xl">
            PARTNERS
            <span class="mx-auto my-1 block h-0.5 max-w-full bg-black"></span>
          </h2>
        </div>
        <div class="animate-on-scroll-in-view animation-delay-500 text-center lg:py-4">
          <div class="mx-auto grid w-full grid-cols-3 lg:w-4/5">
            <img
